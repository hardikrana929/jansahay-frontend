...
const SchemeCard = ({ scheme }) => {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-md border border-gray-100 dark:border-gray-700 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden">
      ...
      <div className="p-5">
        <p className="text-gray-600 dark:text-gray-300 line-clamp-3 leading-7">
          {scheme.description}
        </p>
        ...
        <div className="flex flex-wrap gap-2 mt-5">
          <span className="bg-blue-100 dark:bg-blue-900/40 text-blue-700 dark:text-blue-300 px-3 py-1 rounded-full text-xs font-semibold">
            {scheme.schemeType}
          </span>

          <span className="bg-green-100 dark:bg-green-900/40 text-green-700 dark:text-green-300 px-3 py-1 rounded-full text-xs font-semibold">
            {scheme.government}
          </span>

          <span className="bg-purple-100 dark:bg-purple-900/40 text-purple-700 dark:text-purple-300 px-3 py-1 rounded-full text-xs font-semibold">
            {scheme.state}
          </span>
        </div>
      ...
      <div className="border-t border-gray-100 dark:border-gray-700 px-5 py-4 flex justify-between items-center">
        <Link
          to={`/schemes/${scheme._id}`}
          className="text-blue-600 dark:text-blue-400 font-semibold flex items-center gap-2 hover:underline"
        >
